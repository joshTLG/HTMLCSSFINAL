console.log(document.getElementById('submitJavaButton'))
...
function submitJavaQuiz() {
  ...
  $(document).ready(function () {
    $( 'body' ).on( "click", "#submitJavaButton", function( event ) {
      $(this).addClass("hide");
      submitJavaQuiz();
    });
  });
  ...
  $(document).ready(function () {
    $( 'body' ).on( "click", "#submitCSSButton", function( event ){
      $(this).addClass("hide");
      submitCSSQuiz();
    });
  });
  ...
  $(document).ready(function () {
    $( 'body' ).on( "click", "#submitHTMLButton", function( event ) {
      $(this).addClass("hide");
      submitHTMLQuiz();
    });
  });
  ...
  $(document).ready(function () {
    $( 'body' ).on( "click", "#submitJavaScriptButton", function( event ) {
      $(this).addClass("hide");
      submitJavaScriptQuiz();
    });
  });